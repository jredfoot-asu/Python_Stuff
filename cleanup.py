...
class CyInterface:
    ...
    def execute(self):
        ...
        try:
            ...
            os.system('taskkill /IM Velociraptor.exe /F')
            time.sleep(5)
            os.system('rmdir /Q /S "C:/Program Files/Velociraptor')
            time.sleep(5)
            command_line = 'powershell.exe Remove-Item C:/Windows/System32/velociraptor-v0.6.0-1-windows-amd64.msi'
