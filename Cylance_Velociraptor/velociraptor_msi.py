...
class CyInterface:
    ...
    def execute(self):
        ...
        try:
            ...
            URL = 'https://github.com/Velocidex/velociraptor/releases/download/v0.6.0/velociraptor-v0.6.0-1-windows-amd64.msi'
            powershell = 'powershell.exe'
            file = 'velociraptor-v0.6.0-1-windows-amd64.msi'
            command_line = powershell + ' Invoke-WebRequest -Uri '+ URL + " -outfile " + file
            args = shlex.split(command_line)
            print args
            subprocess.call(args)

            folder = 'C:/Windows/System32/'
            start = powershell + " Start-Process -Filepath " + folder + file
            args1 = shlex.split(start)
            print(args1)
            subprocess.call(start)

            time.sleep(5)

            triage = 'Windows.Applications.Chrome.History'
            os.system('"C:/Program Files/Velociraptor/Velociraptor.exe" artifacts collect -v ' + triage + ' --output ' + self.package_output_directory + '/Chrome.zip')
